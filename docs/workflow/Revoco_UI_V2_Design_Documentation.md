# Revoco — UI/UX Design & Version 2 Implementation Plan
...
Revoco should look like a serious fintech/payment-infrastructure product, **not an AI dashboard**.
...
- The existing Revoco application and already-built functionality.
...
> **revoco** feels like a recognizable product brand.
...
The Revoco wordmark should consistently use the distinctive brand font.
...
The landing page is the public-facing Revoco website.
...
The dashboard preview should represent the actual Revoco product rather than a generic finance dashboard.

---

# 7. Landing Page Flow Visualization

Include the core Revoco flow prominently:
...
Explain that Revoco evaluates permitted signals such as:
...
Connect payment events to Revoco
...
After login, Revoco changes from a marketing website into an operational merchant dashboard.
...
The Overview page is the operational heart of Revoco.
...
This is the core Revoco functionality.
...
- Revoco uses the distinctive brand font
...
The UI redesign must work around the existing Revoco system.
...
- [ ] Revoco branding
- [ ] Distinctive Revoco wordmark font
...
- [ ] Landing page immediately explains Revoco.
- [ ] Revoco branding is visually distinctive.
